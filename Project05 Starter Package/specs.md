...
**Due: Monday, April 6th, 2025 @ 11:59 PM EST**
...
- insert, search, remove method must be implemented recursively instead of using iterations.
...
**2. Auto Graded Tests (100 points)** 
  - `AVLTree`: \_\_/70
    ...
    - `max`: \_\_/3
    - `search`: \_\_/5
    - `inorder`/`__iter__`: \_\_/3
    - `preorder`: \_\_/3
    - `postorder`: \_\_/3
    - `levelorder`: \_\_/3
    - `avl_comprehensive`: \_\_/5
  - `KNNClassifier`: \_\_/30
    - `test_train`: \_\_/5
    - `test_get_k_neighbors`: \_\_/10
...
```
Total points for Project05: ___

Detailed points for each test case:
  1)  test_rotate: 
  2)  test_balance_factor: 
  3)  test_rebalance: 
  4)  test_insert: 
  5)  test_height: 
  6)  test_remove: 
  ...
  12) test_postorder: 
  13) test_levelorder: 
  14) test_avl_comprehensive: 
  15) test_train: 
  16) test_get_k_neighbors: 
  17) test_calculate_best_fit: 
  18) test_knn:
```
