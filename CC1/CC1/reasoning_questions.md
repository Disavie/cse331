...
- After sorting: ___________
- After processing first coin (2): max_constructible = ___________
- After processing second coin (2): max_constructible = ___________
- After processing third coin (2): max_constructible = ___________
- After processing fourth coin (2): max_constructible = ___________
- Final return value: ___________
